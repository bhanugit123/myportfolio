...
function HeroSection() {
  ...
  const handleResumeDownload = () => {
    ...
    link.download = "Bhanu Prakash Thipparthi SDE Resume_EXP.pdf";
    link.click();
  };
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center bg-gradient-to-b from-white via-blue-100 to-blue-200 w-full relative overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="mb-6">
          <img
            src="/myPhoto.jpeg" // Correct static file path
            alt="Bhanu Prakash"
        ...
        <p className="text-xl text-gray-600 mt-6 mb-5 animate-fade-in">
          <b> Full Stack Developer | Interested in Distributed Systems | NYU Grad </b>
        </p>
        ...
        <div className="mt-12 flex justify-center gap-6 animate-fade-in-delayed">
          <SocialLink icon={<GithubIcon />} href="https://www.github.com/bhanugit123" />
          <SocialLink icon={<LinkedInIcon />} href="https://www.linkedin.com/in/bhanuprakashthipparthi/" />
          <SocialLink icon={<LeetCodeIcon />} href="https://leetcode.com/u/bhanu_007/" />
        </div>
      </div>
